import type { Controller, Manifest, Memory, OpenClaw, OpenCodeConfig, PromptEngine, Worker } from './manifest';
export declare const RENDER_TARGETS: readonly ["openclaw.json", "controller.env", "worker.env", "systemd.service", "opencode.launch.yaml"];
