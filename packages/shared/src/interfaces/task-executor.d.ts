 ...
 * 任务执行阶段枚举
 */
export type TaskExecutionStage = 'project_check' | 'server_check' | 'context_build' | 'prompt_compile' | 'execute' | 'result_parse' | 'submit_result';
/**
 * 执行结果解析状态
 */
 ...
 */
export declare function extractOpenCodeConfig(context: TaskExecutionContext): OpenCodeConfig | undefined;
