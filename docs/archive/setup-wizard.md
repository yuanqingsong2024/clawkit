...
> 历史文档说明：本文档主要记录旧版 Setup 向导能力与实现背景。
> 当前推荐入口已切换为 `clawkit init`、`clawkit start`、`pnpm quickstart` 和 `examples/simple.yaml`。
> 若你是新用户，请优先阅读 `docs/simplified-quick-start.md` 与 `docs/quick-start.md`。
